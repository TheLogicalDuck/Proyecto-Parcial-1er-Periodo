...
def main(page: ft.Page):
    ...
    pinturas = [
        {"titulo": "El Lógico","autor": "TheLogicalDuck","año": "2025","descripcion": "La foto de perfil del pato logístico","imagen": "src/assets/EL LOGICAL.png"},
        {"titulo": "Ojitos Wolsom","autor": "Anónimo","año": "2022","descripcion": "Pintura que describe el miedo que puede sentir una persona sensible","imagen": "src/assets/ojitos wolsom.png"},
        ...
        {"titulo": "Recortalte","autor": "Gentleman's barber shop","año": "2023","descripcion": "El chico quiere cambiar su estilo punk, por un ponkpadu","imagen": "src/assets/enlaferia.png"},
    ]
    ...
    boton_anterior = ft.ElevatedButton(text="Pintura anterior")
    ...
    def mostrar_pintura():
        ...
        contenedor.content = ft.Column(
            [
                ...
                ft.Text(pintura["titulo"], size=20, weight=ft.FontWeight.BOLD, text_align=ft.TextAlign.CENTER, color="black"),
                ft.Text(f"Autor: {pintura['autor']}", size=20, text_align=ft.TextAlign.CENTER, color="black"),
                ft.Text(f"Año: {pintura['año']}", size=18, text_align=ft.TextAlign.CENTER, color="black"),
                ft.Text(pintura["descripcion"], size=16, italic=True, text_align=ft.TextAlign.CENTER, color="black")
            ],
